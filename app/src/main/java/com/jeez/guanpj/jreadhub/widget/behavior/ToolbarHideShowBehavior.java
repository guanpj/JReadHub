package com.jeez.guanpj.jreadhub.widget.behavior;
...
public class ToolbarHideShowBehavior extends CoordinatorLayout.Behavior<FloatingActionButton> {

    //定义toolbar高度和状态栏高度
    private int toolbarHeight;
    private double statusBarHeight;

    public ToolbarHideShowBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
