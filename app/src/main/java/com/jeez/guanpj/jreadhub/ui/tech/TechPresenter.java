...
public class TechPresenter extends BasePresenter<TechContract.View> implements TechContract.Presenter {
    ...
    public void doRefresh() {
        mRxManager.add(mDataManager.getNewsList(NewsBean.TYPE_NEWS, null, PAGE_SIZE)
    ...
    public void doLoadMore(Long lastCursor) {
        mRxManager.add(mDataManager.getNewsList(NewsBean.TYPE_NEWS, lastCursor, PAGE_SIZE)
                .compose(RxSchedulers.io2Main())
